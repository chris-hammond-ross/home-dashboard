	...
	return (
		...
		>
			...
			<span
				className="pf-chip"
				style={{
					borderColor: color ?? "var(--hairline)",
				...
				<div className="pf-boardwrap" style={{ flex: 1, minHeight: 0 }}>
					<div className="pf-board">
							...
							<div className="pf-channel">
								<SourceCard
									...
									chip={
										gExport
											? "Exporting"
											: view.gridImportW > EPS
												? "Importing"
												: "Standby"
									}
									kind={
										gExport ? "export" : view.gridImportW > EPS ? "grid" : null
									}
							...
							{view.hasBattery ? (
								<div className="pf-channel">
									<SourceCard
										...
										name="Battery"
										watts={
											bCharge ? view.batteryChargeW : view.batteryDischargeW
										}
										chip={
											bCharge
												? "Charging"
												: view.batteryDischargeW > EPS
													? "Discharging"
													: "Idle"
										}
										kind={
										...
										{view.socPct != null ? (
											<div className="pf-socwrap">
												<div className="pf-socbar">
													<div
														className="pf-socfill"
														style={{ width: `${view.socPct}%` }}
													/>
												</div>
												<div className="pf-soclabel">
													{Math.round(view.socPct)}% charged
												</div>
											</div>
										) : null}
									</SourceCard>
						...
						<div
							className="pf-bus"
							style={{
								["--busglow" as string]: dominant
									? FLOW_COLOR[dominant.kind]
									: "var(--flow-idle)",
							}}
						/>
