...
const ICON_PATHS: Record<NodeId, string> = {
  solar:
    "M6 .6v1.1 M6 7.3v1.1 M2.2 4.5h1.1 M8.7 4.5h1.1 M3.3 1.8l.8.8 M7.9 6.4l.8.8 M8.7 1.8l-.8.8 M4.5 11.5h13l2.2 8h-17.4z M9 11.5l-.8 8 M13 11.5l.8 8 M3.6 15.5h15.8",
  ...
  switch (id) {
    ...
    case "battery":
      if (view.batteryChargeW > EPS)
        return { active: true, kind: "charge", watts: view.batteryChargeW, chip: "Charging" };
  ...
  return (
    ...
    >
      ...
      {id === "battery" && view.socPct != null ? (
        <text x={n.x + 22} y={n.y - 20} fontSize={12} className="pf-val" fill="var(--text-muted)">
      ...
      <g>
        ...
        <text
          ...
          fill={chipColor}
        >
          {st.active ? st.chip : id === "grid" ? "Standby" : id === "battery" ? "Idle" : "Offline"}
        </text>
      </g>
    </g>
  );
