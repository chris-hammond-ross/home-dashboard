      ...
      <div className="cc-card" style={cardBackground(style)}>
        ...
        {showZones ? (
          <div className="cc-bento-stack">
            <MiniControl view={view} style={style} glassy onCycleMode={cycleMode} onStep={step} />
            <div className="cc-ztile-grid">
              {zones.map((zone) => (
                <ZoneRingTile key={zone.entity} climate={climate} zone={zone} style={style} />
              ))}
            </div>
          </div>
        ) : (
          <div className="cc-bento-grid">
            ...
            {view.fanModes.length ? (
              <div className="cc-tile">
                ...
                <FanChips view={view} accent={style.accent} onSelect={climate.setFan} />
              </div>
            ) : null}
