		...
		variants: [
			{
				id: "nocturne",
				label: "Nocturne",
				description: "Glass cards over a drifting aurora",
			},
		...
		variants: [
			{
				id: "node-map",
				label: "Node map",
				description: "Circular nodes with flowing particles",
			},
			{
				id: "switchboard",
				label: "Switchboard",
				description: "Source cards feeding a bus rail",
			},
		],
		fields: [
			{
