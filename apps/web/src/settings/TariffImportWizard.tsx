		...
		>
			<Stack gap="sm">
				<Text size="sm" c="var(--text-secondary)">
					Rates come from the Australian Energy Regulator’s public Consumer Data Right
					feed — the same data behind Energy Made Easy. Pick your retailer and postcode to
					narrow the list to plans available at your address.
				</Text>
				...
				{plans && plans.length === 0 ? (
					<Alert color="yellow" variant="light">
						No residential electricity plans found for that retailer and postcode. Check
						the postcode, or close this and enter your rates by hand.
					</Alert>
				) : null}
