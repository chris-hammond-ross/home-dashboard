...
export function StatisticPickerModal({
  ...
  useEffect(() => {
    ...
    void socket.action(integration, "list-statistic-ids", { statisticType: "sum" }).then((res) => {
  ...
  return (
    <Modal opened={opened} onClose={onClose} title="Browse energy statistics" size="lg" centered>
      <Stack gap="sm">
        {onImportEnergyPrefs ? (
          <Alert variant="light" color="blue">
            <Group justify="space-between" wrap="nowrap" gap="sm">
              <Text size="sm">
                Home Assistant’s Energy dashboard already knows your grid, solar and battery meters.
              </Text>
              <Button
                size="xs"
                variant="light"
