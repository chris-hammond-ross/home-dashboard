  ...
  return (
    <div
      ...
      style={{
        ...
        inset: 0,
        zIndex: 100,
        background: "radial-gradient(120% 90% at 50% 0%, #15171c 0%, var(--page-plane) 65%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      <Stack align="center" gap="sm" style={{ transform: `translate(${shiftX}px, ${shiftY}px)` }}>
        ...
        {nextEvent ? (
          <Text fz="md" c="var(--text-muted)">
            Next · {nextEvent.title} · {formatEventTime(nextEvent.start, nextEvent.allDay)}
          </Text>
        ) : null}
      </Stack>
      <Text
